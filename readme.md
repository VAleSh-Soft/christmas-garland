 ...
 * если модуль использует четыре кнопки, удержание нажатой третьей кнопки увеличивает или уменьшает величину затухания огоньков вершины; но эта настройка работает только если задана не сплошная заливка вершины цветом;
