...
#define SAVE_EEPROM 1 // Сохранять настройки запуска в EEPROM
                      // 0 - ничего не  хранить
                      // 1 - хранить стартовый режим, длина гирлянды, скорости, яркость и расширенные настройки (очередность цвета,состояние блеска, фон свечей)
...
#define EEPROM_INDEX_FOR_ISINIT 16    // Расположение в EEPROM байта корректности записи (1 байт)
