...
Для применения настроек выключить и снова включить модуль;
...
Фон гирлянды может заливаться слабым свечением вместо черного цвета. Доступны три варианта: бледно-голубой (по умолчанию), бледно-зеленый, бледно-красный. Отдельного интерфейса настройки цвета нет, однако можно воспользоваться одним из двух вариантов (при их доступности, конечно).
