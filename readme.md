...
- [Настройки в файле setting.h](#настройки-в-файле-settingh)
  ...
  - [Настройки гирлянды](#настройки-гирлянды)
...
`#define TOP_POSITION 2` - позиция вершины елки (0 - не определена 1 - вершина в начале гирлянды 2 - вершина в конце гирлянды);
...
Если модуль использует менее двух кнопок, то длина гирлянды будет равна величине, заданной макросом `#define MAX_LEDS`;
...
- или (если модуль использует хотя бы одну кнопку), можно настроить этот параметр для конкретной гирлянды, вообще не зная заранее, что гирлянде требуется; порядок действий следующий:
   ...
   * выключить и снова включить моду
...
Если вас не устраивает этот набор команд, можете изменить их по своему усмотрению в разделе **набор команд на кнопках** файла **setting.h**.
