...
#define TOP_DELAY 250 // Задержка эффекта в милисекундах; определяет скорость переливания вершины
 ...
 *     увеличивает или уменьшает величину затухания огоньков вершины;
