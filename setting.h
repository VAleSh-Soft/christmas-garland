...
#define MAX_LEDS 100 // Максимальное количество светодиодов  в гирлянде, ограничивает количество светодиодов сверху (см. комментарий ниже); очень влияет на память
...
#define SAVE_EEPROM 1 // Сохранять настройки запуска в EEPROM
                      // 0 - ничего не  хранить
                      // 1 - хранить стартовый режим, длину гирлянды, задержку, яркость, очередность цветов в чипе и расширенные настройки (состояние блеска, фона, свечей)
