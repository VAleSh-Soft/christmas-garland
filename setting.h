...
// #define LED_CLK_PIN 11 // Номер пина для подключения линии тактирования гирлянды, применяется для светодиодов с четырехпроводным подключение (WS2801, APA102 и т.д.)
...
#define CANDLE_40 1 // Управление 40 эффектом (свечи)
                     ...
                     * efimova1969, иначе при запуске она будет включена по
                     * моему варианту */
...
#define DEMO_MODE 4 // Режим при включении
                     ...
                     * 3 - демо режим с последовательным перебором выбранных
                     *     эффектов
 ...
 *
 * Доступные варианты команд см. в файле getcommands.h; аналогично можно добавлять свои команды
 */
